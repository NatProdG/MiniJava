...
and instruction =
  ...
  | IIfWe of expression * instruction (** [IIfWe (e, i1)] represents the instruction [if (e) i1]. *)
  ...
  | IFor of instruction * expression * instruction * instruction (** [IFor (istart, stop_cond, iinc, iloop)] represents the instruction [for(istart, stop_cond, iinc) iloop]. *)
  | ISwitch of expression * instruction list * instruction list (** [ISwitch (id c li)] represents the instruction [switch(id){ c default:li; }]. *)
  | ICaseB of constant * instruction list (** [ICaseB (i, li)] represents the instruction [case i: li break;]. *)
  | ICase of constant * instruction list (** [ICase (i, li)] represents the instruction [case i: li]. *)
